...
public class QuoteListAdapter extends BaseAdapter {
    ...
    int item_position;
    public QuoteListAdapter(Context context, List<QuoteModel> list) {
                        ...
                        if (serverCode.equalsIgnoreCase("1")) {
                            try {
                                ...
                                if ("1".equals(serverCode)) {
                                    FavQuotesFragment.list.remove(item_position);
                                    FavQuotesFragment.horizontalListAdapter.notifyDataSetChanged();
                                }
