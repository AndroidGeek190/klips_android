...
Prefshelper prefshelper;
    ...
    int item_position;
    public FavListAdapter(Context context, List<VideoModel> list) {
                        ...
                        if (serverCode.equalsIgnoreCase("1")) {
                            try {
                                ...
                                if ("1".equals(serverCode)) {
                                    FavSongsFragment.list.remove(item_position);
                                    FavSongsFragment.horizontalListAdapter.notifyDataSetChanged();
                                }
