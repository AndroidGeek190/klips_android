...
public class VideoPlayListAdapter extends BaseAdapter {
    ...
    int item_position;
    public VideoPlayListAdapter(Context context, List<VideoModel> list) {
          ...
          /*  final ProgressDialog pDialog = new ProgressDialog(context);
            ...
            StringRequest sr = new StringRequest(Request.Method.POST, MapAppConstant.API + "video_playlist_operations", new Response.Listener<String>() {
                        ...
                        if (serverCode.equalsIgnoreCase("1")) {
                            try {
                                ...
                                if ("1".equals(serverCode)) {
                                    PlayListVideosFragment.list.remove(item_position);
                                    PlayListVideosFragment.horizontalListAdapter.notifyDataSetChanged();
                                }
                ...
                protected Map<String, String> getParams() {
                    ...
                    params.put("video_status_id", status);
                    return params;
                }
            };
